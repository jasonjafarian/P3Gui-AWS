...
<title>Prices Paid Portal | Sign In</title><link rel="shortcut icon" href="classic/center/assets/images/gsa.png">
...
<link rel="shortcut icon" href="classic/center/assets/images/gsa.png">
    <!-- Stylesheets -->
<link rel="stylesheet" href="classic/global/css/bootstrap.css">
<link rel="stylesheet" href="classic/global/css/bootstrap-extend.css">
<link rel="stylesheet" href="classic/center/assets/css/site.css">
    <!-- Plugins -->
...
<link rel="stylesheet" href="classic/center/assets/examples/css/pages/login-v2.css">
    <!-- Fonts -->
...
.page-login-v2::before {
    background-image: url("classic/center/assets/images/bg-login.jpeg");
}
...
<div class="brand">
<img class="brand-img img-responsive" style="max-height:60px;" src="classic/center/assets/images/gsa.png" alt="GSA">
...
<script src="classic/center/assets/js/site.js"></script>
<script src="classic/center/assets/js/sections/menu.js"></script>
<script src="classic/center/assets/js/sections/menubar.js"></script>
<script src="classic/center/assets/js/sections/sidebar.js"></script>
...
<script src="classic/global/js/components/jquery-placeholder.js"></script>
<script>
...
function queryLink() {
    if(getParameterByName("query")) {
        location.href = "<%=EbuyOpenHelper.getOmbmaxlink()%>" + '?query=' + getParameterByName("query");
    } else {
        location.href =  "<%=EbuyOpenHelper.getOmbmaxlink()%>";
    }
};
</script>
